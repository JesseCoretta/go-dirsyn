...
func TestSubtreeSpecification(t *testing.T) {
	...
	for idx, raw := range []string{
		...
		`{ base "n=1,n=4,n=1,n=6,n=3,n=1", specificExclusions { chopBefore "n=555", chopAfter "n=14", chopAfter "n=74,n=6" },  minimum 1, maximum 1, specificationFilter item:1.3.6.1.4.1.56521 }`,
		`{}`,
	} {
